...
API_KEY = "e9631c82-31c4-4b8f-902f-ec5586924bf6"

# Función que convierte un nombre de ciudad en coordenadas (lat, lon)
...
# Función que obtiene distancia y duración entre dos coordenadas
